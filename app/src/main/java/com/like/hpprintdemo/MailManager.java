...
public class MailManager {
    ...
    private static final String SENDER_NAME = "17302537571@163.com";
    private static final String SENDER_PASS = "aegis123";
    ...
    private static final String RECIVER_NAME = "fxr23mf47@hpeprint.com";
